            ...
            <div className={"w-nft_card relative font-all"}>
                ...
                <div className={"border-nft-card shadow-xl"}>
                    <img src={'https://ipfs.io/ipfs/' + nftData.ipfsHash} alt={'image'}
                         className="border-nft-card shadow-xl"/>
                </div>
                <div
                    className={"absolute bg-black text-white grid grid-cols-2 h-bottom_card font-black border-bottom-nft-card shadow-xl bottom-0 w-full"}>
